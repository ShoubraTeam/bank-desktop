...
public class ModifyBankAccountForm extends Form {
    ...
    public ActionListener submit() {
        return (e) -> {
            LinkedListPair linkedListPair = Helpers.getValuesFromInputsModify((RowPanelThreeItems<?, ?, ?>[]) EntityConstants.BANK_ACCOUNT_MODIFY_ATTRIBUTES);
            // ADD YOUR CODE HERE
