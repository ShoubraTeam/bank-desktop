...
public class Query12View extends Form {
    ...
    public Query12View() {
        ...
        for (RowPanelTwoItems row : EntityConstants.QUERY_TWELVE) {
            newRow = row;
    ...
    public ActionListener submit() {
        return (e) -> {
            ArrayList<String> values = Helpers.getValuesFromInputs(EntityConstants.QUERY_TWELVE);
            ...
            CreditCardController.QueryTwelve(Integer.parseInt(values.get(0)));
