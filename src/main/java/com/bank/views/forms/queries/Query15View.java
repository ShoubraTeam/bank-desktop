...
public class Query15View extends Form {
    ...
    public Query15View() {
        ...
        for (RowPanelTwoItems row : EntityConstants.QUERY_FIFTEEN) {
            newRow = row;
    ...
    public ActionListener submit() {
        return (e) -> {
            ArrayList<String> values = Helpers.getValuesFromInputs(EntityConstants.QUERY_FIFTEEN);
            ...
            ATMController.QueryFifteen(Integer.parseInt(values.get(0)));
