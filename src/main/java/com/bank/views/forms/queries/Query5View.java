...
public class Query5View extends Form {
    ...
    public Query5View() {
        ...
        for (RowPanelTwoItems row : EntityConstants.QUERY_FIVE) {
            newRow = row;
    ...
    public ActionListener submit() {
        return (e) -> {
            ArrayList<String> values = Helpers.getValuesFromInputs(EntityConstants.QUERY_FIVE);
            ...
            BankAccountController.QueryFive(Integer.parseInt(values.get(0)));
