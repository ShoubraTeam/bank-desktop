...
public class Query6View extends Form {
    ...
    public Query6View() {
        ...
        for (RowPanelTwoItems row : EntityConstants.QUERY_SIX) {
            newRow = row;
    ...
    public ActionListener submit() {
        return (e) -> {
            ArrayList<String> values = Helpers.getValuesFromInputs(EntityConstants.QUERY_SIX);
